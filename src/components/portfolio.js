          ...
          <div class="col-md-8">
            <div class="jumbotron jumbotron-fluid mt-5 bg-secondary border rounded">
              <div class="container1 border border-secondary rounded">
                ...
                <p class="p-2 one">
                  Iam Hemanjali Sailusha Koppuravuri.I am currently pursuing
                  B.Tech 3rd year in VIT AP University I have been learning
                  coding I am good at C Java Python SQL as I am still studying I
                  don't have any experience in jobs but I am very passionate
                  about earning money and being independent.{" "}
                </p>
              </div>
            </div>
            ...
            <div class="jumbotron jumbotron-fluid mt-1 bg-secondary border rounded">
              <div class="container1 border border-secondary rounded">
                ...
                <p class="p-1 one">
                  <ul>
                    <li>C,Motive Computer Education</li>
                    <li>Java,Motive Computer Education</li>
                    <li>
            ...
            <div class="jumbotron jumbotron-fluid mt-1 bg-secondary border rounded">
              <div class="container1 border border-secondary rounded">
                <h3 class="p-2">
                  Contact Me:{" "}
                  <a href="mailto:sailushasahithi15@gmail.com">Email</a>{" "}
                  <a href="LinkedInProfile">LinkedIn</a> +91 8309844942
                </h3>
              </div>
            </div>
          </div>
